package conwayJavaFXSpeedTest1;
...
public class UserInterface {
	...
	**********************************************************************************************/
	...
	// These attributes are used to tell the user, in detail, about the performance
	private Label message_PerformanceDetails = new Label("");
	...
	private DecimalFormat formatThree = new DecimalFormat("0.###");
	...
	**********************************************************************************************/
	...
	public UserInterface(Pane theRoot) {
		...
		setupLabelUI(message_PerformanceDetails, "Arial", 18, 500, Pos.BASELINE_LEFT, 20, controlPanelHeight+75);
	...
	**********************************************************************************************/
	...
	private void startConway() {
		...
		int numberOfFrames = 10000;
		
		Long start = System.nanoTime();
		
		// Loop the simulation as many times and numberOfFrames says
		
		for (int frame = 0; frame < 10000; frame++) runSimulation();
		
		Long stop = System.nanoTime();
		
		Double executionTime = (stop - start) / 1000000.0;
		
		System.out.println("Total execution time: " + executionTime + " ms");
		System.out.println("Framerate: " + executionTime/numberOfFrames + " ms per frame");
		
		message_PerformanceDetails.setText("Total execution time: " + formatOne.format(executionTime) + " ms;   Framerate: " + 
				formatThree.format(executionTime/numberOfFrames) + " ms per frame, or " + (int)(numberOfFrames/executionTime*1000) + " frames/second");
	...
	/**********
	 * This method is run each time the startConway method triggers calls it
	 */
